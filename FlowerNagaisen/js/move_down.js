...
function moveObj(match_array) {
  ...
  for(let i = 0; i < match_array.length; i++) {
    if(match_array[i][1] == 2) {
      y = -90.0  + ((-78.75)-(-90.0 ))*match_array[i][3];
    }else if(match_array[i][1] == 3) {
      y = -78.75 + ((-67.50)-(-78.75))*match_array[i][3];
    }else if(match_array[i][1] == 4) {
      y = -67.50 + ((-56.25)-(-67.50))*match_array[i][3];
    }else if(match_array[i][1] == 5) {
      y = -56.25 + ((-45.00)-(-56.25))*match_array[i][3];
    }else if(match_array[i][1] == 6) {
      y = -45.00 + ((-33.75)-(-45.00))*match_array[i][3];
    }else if(match_array[i][1] == 7) {
      y = -33.75 + ((-22.50)-(-33.75))*match_array[i][3];
    }else if(match_array[i][1] == 8) {
      y = -22.50 + ( -11.25 -(-22.50))*match_array[i][3];
    }else if(match_array[i][1] == 9) {
      y = -11.25 + (   0.00 -(-11.25))*match_array[i][3];
    }else if(match_array[i][1] == 10) {
      y =   0.00 + (  11.25 -   0.00 )*match_array[i][3];
    }else if(match_array[i][1] == 11) {
      y =  11.25 + (  22.50 -  11.25 )*match_array[i][3];
    }else if(match_array[i][1] == 12) {
      y =  22.50 + (  33.75 -  22.50 )*match_array[i][3];
    }else if(match_array[i][1] == 13) {
      y =  33.75 + (  45.00 -  33.75 )*match_array[i][3];
    }else if(match_array[i][1] == 14) {
      y =  45.00 + (  56.25 -  45.00 )*match_array[i][3];
    }else if(match_array[i][1] == 15) {
      y =  56.25 + (  67.50 -  56.25 )*match_array[i][3];
    }else if(match_array[i][1] == 16) {
      y =  67.50 + (  78.75 -  67.50 )*match_array[i][3];
    }else if(match_array[i][1] == 17) {
      y =  78.75 + (  90.00 -  78.75 )*match_array[i][3];
