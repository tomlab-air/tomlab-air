...
function moveObj(match_array) {
  ...
  for(let i = 0; i < match_array.length; i++) {
    if(match_array[i][1] == 2) {
      y = -90.0  + ((-64.29)-(-90.0 ))*match_array[i][3];
    }else if(match_array[i][1] == 3) {
      y = -64.29 + ((-38.57)-(-64.29))*match_array[i][3];
    }else if(match_array[i][1] == 4) {
      y = -38.57 + ((-12.86)-(-38.57))*match_array[i][3];
    }else if(match_array[i][1] == 5) {
      y = -12.86 + (  12.86 -(-12.86))*match_array[i][3];
    }else if(match_array[i][1] == 6) {
      y =  12.86 + (  38.57 -  12.86 )*match_array[i][3];
    }else if(match_array[i][1] == 7) {
      y =  38.57 + (  64.29 -  38.57 )*match_array[i][3];
    }else if(match_array[i][1] == 8) {
      y =  64.29 + (  90.0  -  64.29 )*match_array[i][3];
