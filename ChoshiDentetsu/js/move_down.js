...
function moveObj(match_array) {
  ...
  for(let i = 0; i < match_array.length; i++) {
    if(match_array[i][1] == 2) {
      y = -90.0 + ((-70.0)-(-90.0))*match_array[i][3];
    }else if(match_array[i][1] == 3) {
      y = -70.0 + ((-50.0)-(-70.0))*match_array[i][3];
    }else if(match_array[i][1] == 4) {
      y = -50.0 + ((-30.0)-(-50.0))*match_array[i][3];
    }else if(match_array[i][1] == 5) {
      y = -30.0 + ((-10.0)-(-30.0))*match_array[i][3];
    }else if(match_array[i][1] == 6) {
      y = -10.0 + (( 10.0)-(-10.0))*match_array[i][3];
    }else if(match_array[i][1] == 7) {
      y =  10.0 + (  30.0 -( 10.0))*match_array[i][3];
    }else if(match_array[i][1] == 8) {
      y =  30.0 + (  50.0 -  30.0 )*match_array[i][3];
    }else if(match_array[i][1] == 9) {
      y =  50.0 + (  70.0 -  50.0 )*match_array[i][3];
    }else if(match_array[i][1] == 10) {
      y =  70.0 + (  90.0 -  70.0 )*match_array[i][3];
