...
function moveObj(match_array) {
  ...
  for(let i = 0; i < match_array.length; i++) {
    if(match_array[i][1] == 2) {
      y = -90.0  + ((-76.15)-(-90.0 ))*match_array[i][3];
    }else if(match_array[i][1] == 3) {
      y = -76.15 + ((-62.31)-(-76.15))*match_array[i][3];
    }else if(match_array[i][1] == 4) {
      y = -62.31 + ((-48.46)-(-62.31))*match_array[i][3];
    }else if(match_array[i][1] == 5) {
      y = -48.46 + ((-34.62)-(-48.46))*match_array[i][3];
    }else if(match_array[i][1] == 6) {
      y = -34.62 + ((-20.77)-(-34.62))*match_array[i][3];
    }else if(match_array[i][1] == 7) {
      y = -20.77 + (( -6.92)-(-20.77))*match_array[i][3];
    }else if(match_array[i][1] == 8) {
      y =  -6.92 + (   6.92 -( -6.92))*match_array[i][3];
    }else if(match_array[i][1] == 9) {
      y =   6.92 + (  20.77 -   6.92 )*match_array[i][3];
    }else if(match_array[i][1] == 10) {
      y =  20.77 + (  34.62 -  20.77 )*match_array[i][3];
    }else if(match_array[i][1] == 11) {
      y =  34.62 + (  48.46 -  34.62 )*match_array[i][3];
    }else if(match_array[i][1] == 12) {
      y =  48.46 + (  62.31 -  48.46 )*match_array[i][3];
    }else if(match_array[i][1] == 13) {
      y =  62.31 + (  76.15 -  62.31 )*match_array[i][3];
    }else if(match_array[i][1] == 14) {
      y =  76.15 + (  90.0 -  76.15 )*match_array[i][3];
